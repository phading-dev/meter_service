...
import { GET_MONTHLY_BATCH_RESPONSE } from "@phading/product_meter_service_interface/show/backend/consumer/interface";
  ...
  cases: [
    {
      ...
      execute: async () => {
        ...
        assertThat(
          ...
          eqMessage(
            {
              rowKeys: ["q2#2024-10#consumer1", "q2#2024-10#consumer2"],
              cursor: "q2#2024-10#consumer2",
            },
