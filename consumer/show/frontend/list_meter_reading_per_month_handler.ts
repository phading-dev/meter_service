...
import { ListMeterReadingsPerMonthHandlerInterface } from "@phading/product_meter_service_interface/consumer/show/frontend/handler";
import {
...
import { MeterReadingPerMonth } from "@phading/product_meter_service_interface/consumer/show/frontend/meter_reading";
...
export class ListMeterReadingsPerMonthHandler extends ListMeterReadingsPerMonthHandlerInterface {
  ...
  public async handle(
    ...
    let readings: Array<MeterReadingPerMonth> = rows.map((row) => {
      return {
